...
const ART = (function () {
  ...
  const SHAPES = {
    ...
    coquetel: {
      externo: 'M38,46 C38,76 64,102 100,102 C136,102 162,76 162,46 Z',
      interno: 'M45,52 C45,76 68,97 100,97 C132,97 155,76 155,52 Z',
      haste: 'M100,102 L100,148',
      base: { cx: 100, cy: 151, rx: 29, ry: 5.5 },
      superficie: 58,
      fundo: 97,
      borda: [38, 46, 162, 46],
      apoio: { x: 147, y: 46 },
      topo: { x: 100, y: 38 },
      gelo: [{ x: 82, y: 68, s: 16, r: -16 }, { x: 110, y: 64, s: 14, r: 14 }, { x: 98, y: 82, s: 13, r: 6 }]
    }
  };
